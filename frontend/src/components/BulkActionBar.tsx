...
export function BulkActionBar({
  ...
  return (
    <div
      ...
      className="sticky top-0 z-20 flex h-11 items-center gap-2 overflow-x-auto border-b border-slate-200 bg-white/95 px-3 text-xs shadow-[0_10px_24px_rgba(15,23,42,0.07)] backdrop-blur"
    >
      <span className="inline-flex h-7 shrink-0 items-center rounded-md border border-blue-200 bg-gradient-to-b from-blue-50 to-blue-100/70 px-2.5 font-semibold tabular-nums text-blue-800 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
      ...
      <div className="ml-auto flex items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50/80 p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)]">
        <button
          type="button"
        ...
        <button
          ...
          className="inline-flex h-7 shrink-0 items-center gap-1 whitespace-nowrap rounded-md border border-slate-200 bg-white px-2.5 font-medium text-slate-700 shadow-[0_1px_1px_rgba(15,23,42,0.04)] transition-colors hover:border-amber-200 hover:bg-amber-50 hover:text-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-500/20 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400 disabled:shadow-none"
          onClick={() => void onStop?.()}
        >
        ...
        {tagEditorOpen ? (
          <form
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-md bg-white p-0.5 shadow-[0_1px_2px_rgba(15,23,42,0.06)] ring-1 ring-blue-100"
        ...
        {onClearSelection && (
          <button
            type="button"
            className="inline-flex h-7 shrink-0 items-center gap-1 whitespace-nowrap rounded-md border border-slate-200 bg-white px-2.5 font-medium text-slate-600 shadow-[0_1px_1px_rgba(15,23,42,0.04)] transition-colors hover:border-slate-300 hover:bg-slate-50 hover:text-slate-950 focus:outline-none focus:ring-2 focus:ring-slate-500/15"
