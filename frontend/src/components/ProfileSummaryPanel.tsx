...
export function ProfileSummaryPanel({
  ...
  if (!profile) {
    return (
      <aside
        ...
        className="flex h-full min-h-0 flex-col overflow-hidden rounded-lg border border-dashed border-slate-300 bg-slate-50/80 p-4 text-sm text-slate-500 shadow-[0_1px_2px_rgba(15,23,42,0.045)] ring-1 ring-slate-900/[0.02]"
      >
        <div className="flex items-center justify-between gap-2">
          <span className="text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-400">
            Inspector
          </span>
          <span className="inline-flex h-6 w-6 items-center justify-center rounded-[6px] border border-slate-200 bg-white text-slate-400 shadow-[0_1px_1px_rgba(15,23,42,0.04)]">
            <Monitor className="h-3.5 w-3.5" />
          </span>
        </div>
        <div className="mt-6 rounded-lg border border-slate-200 bg-white p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04),inset_0_1px_0_rgba(255,255,255,0.95)]">
  ...
  return (
    <aside
      role="complementary"
      aria-label="Profile summary"
      className="flex h-full min-h-0 flex-col overflow-hidden rounded-lg border border-slate-200/90 bg-white shadow-[0_10px_26px_rgba(15,23,42,0.055),0_1px_2px_rgba(15,23,42,0.045)] ring-1 ring-slate-900/[0.025]"
    >
      <div className="border-b border-slate-200 bg-slate-50/70 p-4 shadow-[inset_0_-1px_0_rgba(248,250,252,0.98)]">
        <div className="mb-3 flex items-center justify-between gap-2">
          <span className="text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-400">
            Previewing
          </span>
          <span className="rounded-[6px] border border-slate-200 bg-white px-2 py-0.5 text-[10px] font-medium text-slate-500 shadow-[0_1px_1px_rgba(15,23,42,0.035)] ring-1 ring-slate-900/[0.02]">
            Inspector
          </span>
        </div>
        ...
        <button
          type="button"
          className="mt-3 inline-flex h-8 w-full items-center justify-center gap-1 rounded-[6px] border border-slate-200 bg-white text-xs font-medium text-slate-700 shadow-[0_1px_1px_rgba(15,23,42,0.04)] transition-colors hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
      ...
      <div className="min-h-0 flex-1 divide-y divide-slate-100 overflow-y-auto bg-slate-50/55">
        <SummarySection icon={<ShieldAlert className="h-3.5 w-3.5" />} title="Health">
          ...
          {warningSummary && (
            <p className="mt-2 rounded-[6px] border border-amber-200 bg-amber-50 px-2 py-1.5 text-xs text-amber-800 shadow-[0_1px_1px_rgba(180,83,9,0.06)]">
              {warningSummary}
            </p>
          )}
...
function SummarySection({
  ...
  return (
    <section
      aria-label={title}
      className="bg-white px-4 py-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.95)]"
    >
      <div className="mb-3 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-500">
        <span className="flex h-5 w-5 items-center justify-center rounded-[5px] border border-slate-200 bg-slate-50 text-slate-400 shadow-[0_1px_1px_rgba(15,23,42,0.035)]">
          {icon}
        </span>
        {title}
      </div>
