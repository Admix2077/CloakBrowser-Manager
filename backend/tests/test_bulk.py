...
def test_profile_csv_import_redacts_auth_viewer_proxy_source_host_markers(
    app_client: TestClient,
):
    marker_hosts = [
        "auth-token-csv-proxy-marker.example",
        "auth_token_csv_proxy_marker.example",
        "viewer-token-csv-proxy-marker.example",
        "viewer_token_csv_proxy_marker.example",
    ]
    csv_text = "\n".join(
        [
            "name,proxy,platform",
